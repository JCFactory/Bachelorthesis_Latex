...
\section{Requirements and specification book}
...
According to Dr. Knuth's 'Art of Computer Programming', Matlab is 
\cite[lesson 1]{introduction_matlab}
\cite{mathworks}
...
On the left of the picture, there can be depicted the RFID reader which has the default IP of 169.254.1.1. Each time, when detecting a RFID tag, the RFID reader sends the information to Matlab which is running on the desktop PC with the IP 169.254.1.3. After receiving the detected RFID tag's information, the desktop PC transmits the data to MongoDB database running on the laptop with the IP 169.254.1.2. 
...
HUCA hospital, permission photo
...
\subsection{Summary and Outlook of application}
